...
class FieldsListPrinterTest {
    ...
    private val weatherDataRecord = WeatherDataRecord(
        dateTime = LocalDateTime.of(LocalDate.of(1, 1, 1), LocalTime.of(0, 0)),
        date = LocalDate.of(1, 1, 1),
    ...
    inner class GetRequestedFields {
        ...
        fun `should provide full list of values, when error occurs trying to open fields list file`() {
            ...
            assertEquals(listOf(listOf("0.0", "0.0", "0", "0.00", "0001-01-01", "0001-01-01T00:00", "0", "-17.78", "127.00", "0.0", "N", "0.00", "0", "0.0", "10.00", "32.50", "0", "0.0", "38.00", "0", "0.00", "0", "00:00", "N", "16.09")), p.getRequestedFields(listOf(weatherDataRecord)))
        }
